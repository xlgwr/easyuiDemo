...
namespace Valeo.Domain
{
    ...
    /// </summary>
    [Serializable]
    [PetaPoco.TableName("t_TaskOfflineCase")]
    [PetaPoco.PrimaryKey("TaskID")]
    public class TaskOfflineCaseModel
    {
        /// <summary>
        /// 任务id (50201605270001)
        /// </summary>
        ...
        /// <summary>
        /// 搜索年限(0:默认7年 1:全部)(其他条件等界面完成再补充)
        /// </summary>
        public string AgeLimit { get; set; }

        /// <summary>
        /// 查询法庭种类(0:默认所有法庭 1:高等法庭及区域法院及小额钱债 3:破产案/个人债务重组)
        /// </summary>
    ...
    public class TaskOfflineCaseModelVM : TaskOfflineCaseModel
    {
