...
namespace Valeo.Domain
{
    ...
    /// </summary>
    [Serializable]
    [PetaPoco.TableName("t_TaskOfflineCompany")]
    [PetaPoco.PrimaryKey("TaskID")]
    public class TaskOfflineCompanyModel
    {
        /// <summary>
        /// 任务id (50201605270001)
        /// </summary>
        ...
        public class VarKey
        {
            public const string tablename = "t_TaskOfflineCompany";
            public const string TaskID = "TaskID";
            public const string KeyID = "TaskID";
        }
    }
}