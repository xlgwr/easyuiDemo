...
function ajaxLoading() {
    ...
    //$("<div class=\"datagrid-mask-msg\"></div>").html($("#loading").val()).appendTo("body").css({ display: "block", left: ($(document.body).outerWidth(true) - 190) / 2, top: ($(window).height() - 45) / 2 });

    //$.post('/Home/GetTreeByRole',
    //         function (data) {
    //             _menus = data;
...
function InitLeftMenu() {
    ...
    $.each(_menus.menus, function (i, n) {
        ...
        $.each(n.menus, function (j, o) {
            ...
            if (o.menuid == 'NoticeSearch') {
                _notice_title = o.menuname;
                _notice_url = o.url;
                _notice_icon = o.icon;
            }
...
function GotoNotice() {
    ...
    if (_notice_title == null || _notice_title == '') return;
 
    addTab(_notice_title, _notice_url, _notice_icon);
