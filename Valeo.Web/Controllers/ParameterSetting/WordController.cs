...
namespace Valeo.Controllers.ParameterSetting
{
    ...
    public class WordController : BaseController
    {
        ...
        {
            //得到权限
            ViewBag.RoleInfo = LoginUser.ListUserAuthVM.Where(o => o.Mod_id == "Word").ToList();
            return View();
        }
        public JsonResult ListPage(WordModel condition, long page = 1, long rows = 10, string sort = null, string order = "asc")
        {
        ...
        [HttpPost]
        public JsonResult Add(WordModel model)
        {
            var msg = "";
            try
            {
                if (string.IsNullOrEmpty(model.WordKey) || string.IsNullOrEmpty(model.WordValue))
                {
                ...
                msg =BaseRes.WOD_TIT_001+":"+ BaseRes.SPS_MSG_002;
            ...
            catch (Exception ex)
            {
                ...
                msg = BaseRes.WOD_TIT_001 + ":" + BaseRes.SPS_MSG_003;
        ...
        [HttpPost]
        public JsonResult Edit(WordModel model)
        {
            var msg = "";
            try
            {
                ...
                msg = BaseRes.WOD_TIT_001 + ":" + BaseRes.SPS_MSG_004;
                addLog(0, 1, msg, VarKey.ServicePage.ParamManager.ToString());
            ...
            catch (Exception ex)
            {
                ...
                msg = BaseRes.WOD_TIT_001 + ":" + BaseRes.SPS_MSG_006;
                addLog(0, 1, msg, VarKey.ServicePage.ParamManager.ToString());
        ...
        public JsonResult Delete(long id)
        {
            ...
            if (id > 0)
            {
                try
                {
                    ...
                    msg = BaseRes.WOD_TIT_001 + ":" + BaseRes.DLL_MSG_010;
                ...
                catch (Exception ex)
                {
                    ...
                    msg = BaseRes.WOD_TIT_001 + ":" + BaseRes.DLL_MSG_011;
                    addLog(0, 2, msg, VarKey.ServicePage.ParamManager.ToString());
